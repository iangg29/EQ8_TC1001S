...
class GUI:
    def __init__(self, name):
        """
        Manager de la interfaz gráfica de la aplicación.
    ...
    def processImg(self, input):
        """
        Procesa la imagen aplicando filtros dependiendo de las acciones del usuario.
        :param input: Imagen ingresada por el usuario.
        """
        if not input:
            ...
            exitButton = Button(bottom, text="Regresar", fg="#556677", command=lambda: filters.destroy(),
                                justify=CENTER,
                                padx=30, pady=4)
    ...
    def start(self):
        """
        Inicio de la aplicación, se crea el GUI para que el usuario pueda interactuar con la aplicación.
        """
    ...
    def stop(self):
        """
        :return: Cierra la ventana principal de la aplicación.
        """
        self.getTK().destroy()
